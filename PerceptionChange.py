...
def StockSim(Stability, Volatility_Control, Stock_t, perception):
    stability_change = (perception - 1)/50
...
dividendConstant = 47
sharePriceConstant = 0.47
changeInSharePriceConstant = 0.05
##########################################################
def publicPerception(div, Value, perception_t_list, dividendConstant, sharePriceConstant, changeInSharePriceConstant):
    overallSharePriceChange = Value[-1]/Investment_0
    perception_t = dividendConstant * div + sharePriceConstant *  overallSharePriceChange + numericalDifferentiation(Value) * changeInSharePriceConstant # equation for change in opinion
   # print("D:", dividendConstant * div)
    #print("P", sharePriceConstant * overallSharePriceChange)
    #print("C", numericalDifferentiation(Value) * changeInSharePriceConstant)
